...
abbrev w256_nine = [true] ++ nseq 2 false ++  [true] ++ nseq 252 false.

abbrev w64_nine = [true] ++ nseq 2 false ++  [true] ++ nseq 60 false.

abbrev w64_2_63 = nseq 63 true ++ [false].

abbrev w64_zero = nseq 64 false.
