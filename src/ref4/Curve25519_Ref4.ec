...
module M_ref4 = {
  proc __load4 (p:W64.t) : W64.t Array4.t = {
    ...
    i <- 0;
    while (i < 4) {
      a.[i] <- (loadW64 Glob.mem (W64.to_uint (p + (W64.of_int (8 * i)))));
      i <- i + 1;
    }
    return (a);
  }
  ...
  proc __curve25519_ref4_ptr (rp:W64.t, kp:W64.t, up:W64.t) : unit = {
    
    var k:W64.t Array4.t;
    var u:W64.t Array4.t;
    var r:W64.t Array4.t;
    k <- witness;
    r <- witness;
  ...
  proc __curve25519_ref4_base_ptr (rp:W64.t, kp:W64.t) : unit = {
  ...
  proc jade_scalarmult_curve25519_amd64_ref4 (qp:W64.t, np:W64.t, pp:W64.t) : 
  W64.t = {
  ...
  proc jade_scalarmult_curve25519_amd64_ref4_base (qp:W64.t, np:W64.t) : 
  W64.t = {
